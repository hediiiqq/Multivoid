...
inline Lane LaneForKind(ReliableKind k) {
    ...
    // v143 (water_sync): WaterState rides Normal. Low-rate continuous scalar sync (bucket fill,
...
inline bool IsClientRelayableReliableKind(ReliableKind k) {
    ...
    // WaterState is NOT relayable (v143): bucket/sponge water is HOST-ARBITRATED. A client
